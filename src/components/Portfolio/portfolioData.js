const portfolioData = [
  {
    ...
    tags: [
      "C# (ASP.NET Core Web API)", ".NET Core", "Swagger", "Authentication: ASU CAS SSO, JWT",  "Entity Framework", "React.js", "Material UI / MUI X Pro", "React Router",
      "JavaScript (ES6+)", "HTML5", "CSS3/SCSS", "SQL (SQL Server, PostgreSQL, Redshift)", "Azure", "fetch", "Power Automate"
    ]
  },
  {
  name: "Student Hiring System (Python + React Stack)",
  github: [
    {
  ...
  tags: [
    ...
    "Authentication: ASU CAS SSO, JWT", "Swagger/OpenAPI", 
    "React.js (ES6+)", "Material UI / MUI X Pro", "React Router", 
    "Axios", "fetch", "React Context", "CSS3/SCSS", "Power Automate", 
    "React Testing Library", "Jest", "Azure", "GitHub", "GitHub Actions"
  ]
},
{
  name: "InsightAI",
  link: "", // If you have a live demo, add the URL; otherwise, leave blank
  github: [
    {
      label: "GitHub Repo",
  ...
  tags: [
    "Python 3.11+", "Streamlit", "OpenAI GPT-4", "Document Q&A", "Chatbot",
    "File Upload (PDF, DOCX, XLSX, CSV)", "SQLite", "python-dotenv",
...
},
{
  ...
  tags: [
    "Python", "OpenAI API", "CLI", "Prompt Engineering", "python-dotenv",
    "LLM Playground", "Experimentation", "AI Prototyping"
  ]
},
{
